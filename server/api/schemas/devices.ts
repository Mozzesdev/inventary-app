...
const deviceSchema = z.object({
  ...
  purchase_date: z.string().refine(date => !isNaN(Date.parse(date)), { message: "Invalid purchase date" }),
  production_date: z.string().refine(date => !isNaN(Date.parse(date)), { message: "Invalid production date" }),
  expiration_date: z.string().refine(date => !isNaN(Date.parse(date)), { message: "Invalid expiration date" }),
